        ...
        <section v-if="mostrarDatos" class="pageHijo">
          <ul class="pokemons">
            ...
            <img class="pokeGif"
              ...
              <li class="namePoke">{{ pokemon.name.charAt(0).toUpperCase() + pokemon.name.slice(1) }}</li>
            <li v-if="pokemon.types.length">Tipo(s): {{ pokemon.types.map(type => type.type.name).join(', ') }}</li>
            <li v-if="pokemon.id">Número: {{ pokemon.id }}</li>
            <li v-if="pokemon.height">Altura: {{ pokemon.height / 10 }} m</li>
            <li v-if="pokemon.weight">Peso: {{ pokemon.weight / 10 }} kg</li>
          </ul>
